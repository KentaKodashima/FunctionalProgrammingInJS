...
//    we separate the tasks into small functions that doesn't mutate anything
//    and combine them at the end to achieve the inital goal
...
const formatResults = (user) =>
  calcScore(user) + ' out of ' + calcPossible(user)
